...
import { ShoppingBag, HeartHandshake, Store, Send, Lightbulb, RotateCcw } from 'lucide-react'
...
const agents: Record<AgentType, {
  ...
  LOCAL: {
    ...
    icon: Store,
    color: '#F59E0B',
    greeting: 'Olá! Sou seu especialista em tráfego pago para negócios locais.\n\nAtendo delivery, clínicas odontológicas, lojas de iPhone e eletrônicos, academias, salões de beleza e qualquer negócio com foco local.\n\nPosso ajudar com geração de leads, campanhas de captação, raio geográfico, WhatsApp como conversão e muito mais.\n\nMe conta: qual é o nicho e o desafio do seu cliente?',
    suggestions: [
      {
        title: 'Delivery sem pedidos',
        prompt: 'Tenho um cliente de delivery de hambúrguer artesanal. Gastamos R$2k no mês no Meta Ads mas os pedidos pelo iFood e WhatsApp estão estagnados. O que pode estar errado e como melhorar?',
      },
      {
        title: 'Leads para clínica odontológica',
        prompt: 'Uma clínica odontológica quer captar pacientes para implante dentário (ticket R$4.500). Verba de R$3k/mês no Meta Ads. Como estruturo as campanhas de lead e qual é o fluxo de atendimento ideal?',
      },
      {
        title: 'Loja de iPhone — concorrência de preço',
        prompt: 'Uma loja de iPhones seminovos está perdendo vendas para lojas grandes no Google. Verba de R$5k. Como competir com anúncios locais e qual campanha priorizar: Google Ads ou Meta?',
      },
      {
        title: 'Raio geográfico e segmentação',
        prompt: 'Qual é a melhor estratégia de segmentação geográfica para um restaurante que atende bairros específicos? Devo usar raio de distância, cidades ou bairros no Meta Ads?',
      },
      {
        title: 'WhatsApp como conversão',
        prompt: 'O cliente quer usar o WhatsApp como canal principal de vendas. Como configuro campanhas de Click to WhatsApp no Meta e quais métricas acompanhar para saber se está funcionando?',
      },
      {
        title: 'Sazonalidade negócio local',
        prompt: 'Uma clínica de estética tem queda de 40% em janeiro e fevereiro. Como planejar campanhas de baixa temporada para manter o fluxo de clientes nesses meses?',
      },
    ],
  },
  CS: {
...
// Access control: which agents each role can see
